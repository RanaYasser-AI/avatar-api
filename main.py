...
# 🔗 حطي هنا الـ IDs اللي جبتيها من جوجل درايف بالظبط مكان المكتوب
...
# أول ما السيرفر يقوم، هينزل الملفات الكبيرة أوتوماتيك لو مش موجودة
...
def get_avatar_landmarks(word: str):
    try:
        ...
        X_data = np.load(os.path.join(AVATAR_DATA_DIR, "X.npy"))
